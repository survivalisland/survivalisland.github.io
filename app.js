...
var story10 = new story(["You eat all the Y U M M Y berries.", "Those berries energize and uplift you."], "Now that you are fully awake, what do you want to do? (1)Make weapons (2)Make some friends", "2", "1");
...
var story12 = new story(["The pig eats all the Y U M M Y berries.", "The pig now follows you around.", "You just made a friend! You name him Piglet."], "What do you want to do with Piglet? (1)Train your friend to fight (2)Go play in the ocean", "2", "1");
var story13 = new story(["You and Piglet go into the ocean.", "You have fun until the sun sets.", "You and your Piglet head back to your shelter.", "You go to sleep with Piglet.", "You wake up the next day and eat berries with Piglet."], "What now?  (1)Spell out 'Help!' on the beach (2)Learn how to make fire", "1", "2");
...
function death() {
    ...
    switch (int) {
        ...
        case 8:
            ...
            appendText("You realize that you do not know how to build a boat.");
